...
<link rel="stylesheet"
	...
	<section class="FaqCrud">
		...
		<section class="faqInsert">
			<form action="${pageContext.request.contextPath}/admin/faq/faqInsert.do" method="POST" >
   				<fieldset>
    				<legend>> FAQ 등록하기</legend>
    				<div class="crud-bot"></div>
        				<label for="question">제목 : </label><br>
        					<textarea name="question" id="question" cols="100" rows="3"></textarea><br/>
    					<label for="answer">답변 : </label><br>
        					<textarea name="answer" id="answer" cols="100" rows="10"></textarea><br>
        					<br><br>
