		...
		<div id="header-container">
			...
			<div class="header-line">
				<a href="${pageContext.request.contextPath}">
					<p class="header-line-text">약한 팀의 DRUGSTORE에 오신 것을
						환영합니다!🥰🎉🥰🎉</p>
				</a>
			</div>
			<!-- 상단 메뉴 -->
				...
				<div class="nav header-nav-list-wrap">
					<ul class="header-nav-list">
						<li class="header-nav-item">
							<a href="${pageContext.request.contextPath}/servey/servey.do" class="header-nav-text">건강설문</a>
						</li>
						<li class="header-nav-item">
							<a href="${pageContext.request.contextPath}/subscription/product.do" class="header-nav-text">정기구독</a>
						</li>
						<li class="header-nav-item">
							<a class="header-nav-text" href="${pageContext.request.contextPath}/notice/noticeList.do">고객센터</a>
						</li>
						<sec:authorize access="hasRole('ADMIN')">
							<li class="header-nav-item">
								<a class="header-nav-text" href="${pageContext.request.contextPath}/admin/user/userList.do">관리자</a>
							</li>
						</sec:authorize>
						<sec:authorize access="isAnonymous()">
							<li class="header-nav-item">
								<a href="${pageContext.request.contextPath}/member/memberLogin.do" class="header-nav-text">로그인</a>
							</li>
						</sec:authorize>
						<sec:authorize access="isAuthenticated()">
							<li class="header-nav-item">
								<a class="header-nav-text" href="${pageContext.request.contextPath}/intakeCheck/intakeCheck.do">섭취체크</a>
							</li>
							<%-- <sec:authentication property="principal.username"/> --%>
							<%-- <sec:authentication property="authorities"/> --%>
							<li class="header-nav-item" name="logoutLink">
								<a href="#" class="header-nav-text">로그아웃</a>
							</li>
				...
				<div class="wrap_inner relative header-bottom">
							...
							<sec:authorize access="isAuthenticated() && !hasRole('ADMIN')">
                  				<li class="categoryList1 header-menu-item">
                  					<a href="${pageContext.request.contextPath}/chat/chat.do" class="header-menu-title">
                  						<img id="chatImg" src="${pageContext.request.contextPath}/resources/images/792.gif" alt="chat" />
                  					</a>
								</li>
							</sec:authorize>
						</ul>
					...
					<div class="header-bottom-right relative">
						...
						<div class="header-cart">
							<a href="${pageContext.request.contextPath}/cart/cartList.do" class="header-cart-link hand">
								<i class="fa-solid fa-cart-shopping"></i>
							</a>
							<p class="header-cart-count hand">0</p>
							<!-- 호버시 장바구니 내역 보이게 작성 -->
						</div>
						<a href="${pageContext.request.contextPath}/member/memberMyPage.do" class="header-mypage">
