		            ...
		            <form:form name="writeform" action="${pageContext.request.contextPath}/review/reviewUpdate.do" id="writeform"
		                ...
		                <div class="table-wrap">
		                    ...
		                    <div>
		                        ...
		                        <div class="products__star--checkbox">
		                            <div class="score-wrap">
		                                <input type="radio" name="star" id="star05" class="star-input hide" value="5" ${review.star eq 5 ? "checked" : ""}>
		                                <label for="star05" class="score"></label>
		                                <input type="radio" name="star" id="star04" class="star-input hide" value="4" ${review.star eq 4 ? "checked" : ""}>
		                                <label for="star04" class="score"></label>
		                                <input type="radio" name="star" id="star03" class="star-input hide" value="3" ${review.star eq 3 ? "checked" : ""}>
		                                <label for="star03" class="score"></label>
		                                <input type="radio" name="star" id="star02" class="star-input hide" value="2" ${review.star eq 2 ? "checked" : ""}>
		                                <label for="star02" class="score"></label>
		                                <input type="radio" name="star" id="star01" class="star-input hide" value="1" ${review.star eq 1 ? "checked" : ""}>
		                    ...
		                    <div>
		                        ...
		                        <textarea name="content" id="content" class="contents-textarea">${review.content}</textarea>
		                    </div>
		                    <div>
		                        <p class="mobile-file-name">첨부파일</p>
		                        <p class="mobile-file-info">* 최대 20MB까지 가능</p>
		                        <c:forEach items="${review.attachments}" var="attachment" varStatus="vs">
